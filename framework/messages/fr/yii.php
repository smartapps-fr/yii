...
return array (
  ...
  'Class name "{class}" does not match class file "{file}".' => 'Le nom de classe « {class} » ne correspond pas au fichier de classe « {file} ».',
  'Failed to start session.' => 'Impossible de démarrer la session.',
  'GD with FreeType or ImageMagick PHP extensions are required.' => 'Les extensions PHP GD avec FreeType ou ImageMagick sont nécessaires.',
  'Internal error while generating hash.' => 'Erreur interne lors de la génération du hachage.',
  'No encryption key specified.' => 'Aucune clé de chiffrement spécifiée.',
  'Unable to generate random string.' => 'Impossible de générer une chaîne aléatoire.',
  'CApcCache requires PHP {extension} extension to be loaded.' => 'L\'extension PHP {extension} doit être chargée pour pouvoir utiliser CApcCache.',
  'CHttpSession.gcProbability "{value}" is invalid. It must be a float between 0 and 100.' => 'La propriété CHttpSession.gcProbability « {value} » est invalide. Ce doit être un flottant compris entre 0 et 100.',
  'Failed to set unsafe attribute "{attribute}" of "{class}".' => 'Impossible de définir l\'attribut « {attribute} » de la classe « {class} ».',
  'Filter "{filter}" is invalid. Controller "{class}" does not have the filter method "filter{filter}".' => 'Le filtre « {filter} »  est invalide. Le contrôleur « {class} » ne possède pas la méthode de filtrage « filter{filter} ».',
  'No' => 'Non',
  'The file "{file}" cannot be uploaded. Only files of these MIME-types are allowed: {mimeTypes}.' => 'Le fichier « {file} » ne peut être téléchargé. Les types MIME autorisés sont: {mimeTypes}.',
  'The requested view "{name}" was not found.' => 'La vue demandée « {name} » n\'a pas été trouvée.',
  'This content requires the <a href="https://www.adobe.com/go/getflash/">Adobe Flash Player</a>.' => 'Ce contenu nécessite le <a href="http://www.adobe.com/go/getflash/">Lecteur Flash d\'Adobe</a>.',
  'Unable to upload the file "{file}" because of an unrecognized error.' => 'Impossible de télécharger le fichier « {file} » en raison d\'une erreur non reconnue.',
  'Yes' => 'Oui',
  '{n} B' => '{n} o',
  '{n} GB' => '{n} Go',
  '{n} KB' => '{n} ko',
  '{n} MB' => '{n} Mo',
  '{n} TB' => '{n} To',
  '{n} byte|{n} bytes' => '{n} octet|{n} octets',
  '{n} gigabyte|{n} gigabytes' => '{n} gigaoctet|{n} gigaoctets',
  '{n} kilobyte|{n} kilobytes' => '{n} kilooctet|{n} kilooctets',
  '{n} megabyte|{n} megabytes' => '{n} mégaoctet|{n} mégaoctets',
  '{n} terabyte|{n} terabytes' => '{n} téraoctet|{n} téraoctets',
